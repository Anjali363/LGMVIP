          ...
          <>
            <nav className="navbar">
              <div className="navitems">
                <h2><span>SHINDE</span>ENTERPRISES</h2>
            ...
            <footer className="footer">
              <h1>Created By <a href="https://www.linkedin.com/in/anjali-shinde-84a4221a9/" target="_blank">Anjali Shinde</a> | All Rights Reserved! </h1>
            </footer>
          </>
        );
      }
